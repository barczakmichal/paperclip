...
export function OrgChart() {
  const { t } = useTranslation("orgChartPage");
  ...
  useEffect(() => {
    setBreadcrumbs([{ label: t("breadcrumb", "Org Chart") }]);
  }, [setBreadcrumbs, t]);
  ...
  if (!selectedCompanyId) {
    return <EmptyState icon={Network} message={t("selectCompany", "Select a company to view the org chart.")} />;
  }
  ...
  if (orgTree && orgTree.length === 0) {
    return <EmptyState icon={Network} message={t("empty", "No organizational hierarchy defined.")} />;
  }
      ...
      <div className="mb-2 flex shrink-0 flex-wrap items-center justify-start gap-2">
        <Link to="/company/import">
          <Button variant="outline" size="sm">
            ...
            {t("importCompany", "Import company")}
          </Button>
        </Link>
        <Link to="/company/export">
          <Button variant="outline" size="sm">
            <Download className="mr-1.5 h-3.5 w-3.5" />
            {t("exportCompany", "Export company")}
          </Button>
        </Link>
      </div>
      <div
      ...
      >
        ...
        <div className="absolute top-3 right-3 z-10 flex flex-col gap-1.5">
          ...
          <button
            ...
            aria-label={t("fitChartToScreen", "Fit chart to screen")}
          >
