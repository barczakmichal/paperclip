...
export function Org() {
  ...
  if (!selectedCompanyId) {
    return <EmptyState icon={GitBranch} message={t("selectCompany", "Select a company to view org chart.")} />;
  }
  ...
  return (
    <div className="space-y-4">
      ...
      {data && data.length === 0 && (
        <EmptyState
          icon={GitBranch}
          message={t("empty", "No agents in the organization. Create agents to build your org chart.")}
        />
      )}
