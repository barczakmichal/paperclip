...
export function GoalProperties({ goal, onUpdate }: GoalPropertiesProps) {
  const { t } = useTranslation("goalProperties");
  ...
  return (
    <div className="space-y-4">
      <div className="space-y-1">
        ...
        <PropertyRow label={t("level", "Level")}>
          {onUpdate ? (
            <PickerButton
              current={goal.level}
              options={GOAL_LEVELS}
        ...
        <PropertyRow label={t("owner", "Owner")}>
          {ownerAgent ? (
            <Link
        ...
        {goal.parentId && (
          <PropertyRow label={t("parentGoal", "Parent Goal")}>
            <Link
      ...
      <div className="space-y-1">
        ...
        <PropertyRow label={t("updated", "Updated")}>
