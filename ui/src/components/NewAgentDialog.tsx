...
export function NewAgentDialog() {
  const { t } = useTranslation("newAgentDialog");
  ...
  function handleAskCeo() {
    ...
    openNewIssue({
      ...
      title: t("createAgentTitle", "Create a new agent"),
      description: t("createAgentDescription", "(type in what kind of agent you want here)"),
    });
  }
    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-2.5 border-b border-border">
          <span className="text-sm text-muted-foreground">{t("addNewAgent", "Add a new agent")}</span>
          <Button
            variant="ghost"
            size="icon-xs"
          ...
          {!showAdvancedCards ? (
            <>
              ...
              <div className="text-center space-y-3">
                ...
                <p className="text-sm text-muted-foreground">
                  {t("recommendation", "We recommend letting your CEO handle agent setup — they know the org structure and can configure reporting, permissions, and adapters.")}
                </p>
              </div>

              <Button className="w-full" size="lg" onClick={handleAskCeo}>
                <Bot className="h-4 w-4 mr-2" />
                {t("askCeo", "Ask the CEO to create a new agent")}
              </Button>
              ...
              <div className="text-center">
                ...
                >
                  {t("advancedConfig", "I want advanced configuration myself")}
                </button>
              </div>
            </>
          ) : (
            <>
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  {t("chooseAdapterType", "Choose your adapter type for advanced setup.")}
                </p>
              </div>
