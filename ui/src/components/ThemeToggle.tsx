...
export function ThemeToggle({ className, variant = "icon", onAfterToggle }: ThemeToggleProps) {
  ...
  const label = isDark
    ? t("component.sidebarAccountMenu.switchToLightMode")
    : t("component.sidebarAccountMenu.switchToDarkMode");
  const description = t("component.sidebarAccountMenu.toggleThemeDesc");
