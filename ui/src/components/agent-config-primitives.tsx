...
export function ChoosePathButton() {
  ...
  return (
    <>
      ...
      >
        {t("agent.config.choosePath")}
      </button>
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>{t("agent.config.choosePathDialog.title")}</DialogTitle>
            <DialogDescription>
              {t("agent.config.choosePathDialog.description")}
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4 text-sm">
            <section className="space-y-1.5">
              <p className="font-medium">{t("agent.config.choosePathDialog.macosTitle")}</p>
              <ol className="list-decimal space-y-1 pl-5 text-muted-foreground">
                <li>{t("agent.config.choosePathDialog.macosStep1")}</li>
                <li>{t("agent.config.choosePathDialog.macosStep2")}</li>
                <li>{t("agent.config.choosePathDialog.macosStep3")}</li>
                <li>{t("agent.config.choosePathDialog.macosStep4")}</li>
              </ol>
            ...
            <section className="space-y-1.5">
              <p className="font-medium">{t("agent.config.choosePathDialog.windowsTitle")}</p>
              <ol className="list-decimal space-y-1 pl-5 text-muted-foreground">
                <li>{t("agent.config.choosePathDialog.windowsStep1")}</li>
                <li>{t("agent.config.choosePathDialog.windowsStep2")}</li>
                <li>{t("agent.config.choosePathDialog.windowsStep3")}</li>
                <li>{t("agent.config.choosePathDialog.windowsStep4")}</li>
              </ol>
              <p className="rounded-md bg-muted px-2 py-1 font-mono text-xs">
            ...
            <section className="space-y-1.5">
              <p className="font-medium">{t("agent.config.choosePathDialog.terminalTitle")}</p>
              <ol className="list-decimal space-y-1 pl-5 text-muted-foreground">
                <li>{t("agent.config.choosePathDialog.terminalStep1")}</li>
                <li>{t("agent.config.choosePathDialog.terminalStep2")}</li>
                <li>{t("agent.config.choosePathDialog.terminalStep3")}</li>
              </ol>
            </section>
          </div>
          <DialogFooter>
