...
function SortableProjectItem({
  ...
  const { t } = useTranslation("sidebarProjects");
  const {
    attributes,
    listeners,
    setNodeRef,
    ...
    >
      <div className="flex flex-col gap-0.5">
        <NavLink
          ...
          className={cn(
            ...
            activeProjectRef === routeRef || activeProjectRef === project.id
              ? "bg-accent text-accent-foreground shadow-[var(--glow-active)]"
        ...
        >
          ...
          {project.pauseReason === "budget" ? <BudgetSidebarMarker title={t("projectPausedByBudget", "Project paused by budget")} /> : null}
        </NavLink>
      ...
      <div className="group">
        <div className="flex items-center px-3 py-1.5">
          ...
          <button
            ...
            aria-label={t("newProject", "New project")}
          >
